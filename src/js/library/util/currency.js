...
const Currency = {
     ...
     */
    getPrice(s, opt_rgx, opt_thousandsSep) {
    ...
    formatCurrency(value) {
        ...
        return this._formatCurrency(currency.thousandsSeperator, currency.decimalSeperator, currency.numDecimals,
     ...
     */
    _formatCurrency(thousandsSeperator, decimalSeperator, numDecimals, strFormat, value) {
        ...
        split[0] = this.insertCommas(split[0], thousandsSeperator);
